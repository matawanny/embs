...
do
        ...
        then
          ...
          f [ ! -f "/net/ybr-prodnfs11/vendordata-PROD/data-grp15/embsdata/embs/daily/$as_of_date/Products/FNMDISCL.ZIP" ]
          then
            FNMDISCL_MISSING=true
          fi          
          f [ ! -f "/net/ybr-prodnfs11/vendordata-PROD/data-grp15/embsdata/embs/daily/$as_of_date/Products/FNMDUSMBS.ZIP" ]
          then
